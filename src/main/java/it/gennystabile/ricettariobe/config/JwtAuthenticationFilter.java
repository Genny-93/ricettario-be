...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        //Ricerca del token all'interno dei Cookie anziché nell'Header "Authorization"
        if (request.getCookies() != null) {
            for (Cookie cookie : request.getCookies()) {
                // Il nome "auth_token" deve corrispondere esattamente a quello definito nel Controller di Login
        ...
        // Se il token è assente nei cookie, la richiesta passa direttamente al filtro successivo.
